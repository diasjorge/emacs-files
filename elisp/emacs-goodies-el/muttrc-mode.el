...
(defconst muttrc-variables-alist
  '(("abort_nosubject" quadoption "ask-yes")
    ...
    ("display_filter" path "")
    ("dotlock_program" path "/usr/local/bin/mutt_dotlock")
    ("dsn_notify" string "")
    ("dsn_return" string "")
    ...
    ("index_format" string "%4C %Z %{%b %d} %-15.15L (%4l) %s")
    ...
    ("pgp_autosign" boolean nil)
    ("pgp_autoencrypt" boolean nil)
    ("pgp_ignore_subkeys" boolean t)
    ("pgp_entry_format" string "%4n %t%f %4l/0x%k %-4a %2c %u")
    ("pgp_good_sign" regexp "")
    ("pgp_long_ids" boolean nil)
    ("pgp_replyencrypt" boolean t)
    ("pgp_replysign" boolean nil)
    ("pgp_replysignencrypted" boolean nil)
    ...
    ("pgp_sort_keys" pgp-sort-order "address")
    ("pgp_create_traditional" quadoption "no")
    ...
    ("ssl_usesystemcerts" boolean t)
    ("entropy_file" path "")
    ("ssl_use_sslv2" boolean t)
    ...
    ("smileys" regexp "(>From )|(:[-^]?[][)(><}{|/DP])")
    ("sleep_time" number 1)
    ("sort" sort-order "date")
    ("sort_alias" alias-sort-order "alias")
    ("sort_aux" aux-sort-order "date")
    ("sort_browser" browser-sort-order "subject")
    ("sort_re" boolean t)
    ("spoolfile" path "")
